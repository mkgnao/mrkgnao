<?php namespace App\Http\TeamWorkPm\Project;

class People extends \App\Http\TeamWorkPm\Rest\Model
{
    ...
    private function validates($project_id, $person_id)
    {
        ...
        if ($person_id <= 0) {
            throw new \App\Http\TeamWorkPm\Exception('Invalid param person_id');
        }
    }
